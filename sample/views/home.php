                            ...
                            <div id="gallery" class="gallery zoom-gallery gallery-6-cols wow fadeInUp"
                                ...
                                <div class="item">
                                    <figure class="position-relative">
                                        <a href="<?= assets('images/menu/view/pf%20(1).jpg') ?>" title="Chocolate Croissant">
                                            <span class="d-hover">
                                                <span class="d-text">
                                                    <span class="d-cap">View</span>
                                                </span>
                                            </span>
                                            <img class="img-gall" src="<?= assets('images/menu/pf%20(1).jpg') ?>" alt="">
                                        </a>
                                    </figure>
                                </div>
                                <!-- close gallery item -->
                                ...
                                <div class="item">
                                    <figure class="position-relative">
                                        <a href="<?= assets('images/menu/view/pf%20(2).jpg') ?>" title="Croissant">
                                            <span class="d-hover">
                                                <span class="d-text">
                                                    <span class="d-cap">View</span>
                                                </span>
                                            </span>
                                            <img class="img-gall" src="<?= assets('images/menu/pf%20(2).jpg') ?>" alt="">
                                        </a>
                                    </figure>
                                </div>
                                <!-- close gallery item -->
                                ...
                                <div class="item">
                                    <figure class="position-relative">
                                        <a href="<?= assets('images/menu/view/pf%20(3).jpg') ?>" title="Doughnuts">
                                            <span class="d-hover">
                                                <span class="d-text">
                                                    <span class="d-cap">View</span>
                                                </span>
                                            </span>
                                            <img class="img-gall" src="<?= assets('images/menu/pf%20(3).jpg') ?>" alt="">
                                        </a>
                                    </figure>
                                </div>
                                <!-- close gallery item -->
                                ...
                                <div class="item">
                                    <figure class="position-relative">
                                        <a href="<?= assets('images/menu/view/pf%20(4).jpg') ?>" title="Wheat Bread">
                                            <span class="d-hover">
                                                <span class="d-text">
                                                    <span class="d-cap">View</span>
                                                </span>
                                            </span>
                                            <img class="img-gall" src="<?= assets('images/menu/pf%20(4).jpg') ?>" alt="">
                                        </a>
                                    </figure>
                                </div>
                                <!-- close gallery item -->
                                ...
                                <div class="item">
                                    <figure class="position-relative">
                                        <a href="<?= assets('images/menu/view/pf%20(5).jpg') ?>" title="Butterfly Cookies">
                                            <span class="d-hover">
                                                <span class="d-text">
                                                    <span class="d-cap">View</span>
                                                </span>
                                            </span>
                                            <img class="img-gall" src="<?= assets('images/menu/pf%20(5).jpg') ?>" alt="">
                                        </a>
                                    </figure>
                                </div>
                                <!-- close gallery item -->
                                ...
                                <div class="item">
                                    <figure class="position-relative">
                                        <a href="<?= assets('images/menu/view/pf%20(6).jpg') ?>" title="Chocolate Puff Pastry">
                                            <span class="d-hover">
                                                <span class="d-text">
                                                    <span class="d-cap">View</span>
                                                </span>
                                            </span>
                                            <img class="img-gall" src="<?= assets('images/menu/pf%20(6).jpg') ?>" alt="">
                                        </a>
                                    </figure>
                                </div>
                                <!-- close gallery item -->
