...
<body class="page-menu">
    ...
    <div id="wrapper">
        ...
        <section id="subheader" class="jarallax text-light">
            <img src="<?= assets('images/background/bg-8.jpg') ?>" class="jarallax-img" alt="">
            <div class="container">
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-center wow fadeInUp">
                            <h2 class="s1 mb-40">Blog</h2>
                            <h2>10 Reasons to Use Saffron Every Day</h2>                            
                        </div>
                    </div>
                </div>
                <div class="col-lg-12">
                    <ol class="breadcrumb">
                      ...
                      <li class="breadcrumb-item active" aria-current="page">10 Reasons to Use Saffron Every Day</li>
                    </ol>
                </div>
            </div>
        </section>
                            ...
                            <div class="de-post-read">
                                        ...
                                        <div class="post-text">
                                            ...
                                            <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt
                                                ...
                                                <div class="row zoom-gallery mb-4">
                                                    <div class="col-lg-6">
                                                        <figure class="hover-zoom position-relative rounded-20 overflow-hidden">
                                                                <a href="<?= assets('images/misc/1.jpg') ?>">
                                                                    <span class="d-hover">
                                                                        <span class="d-text">
                                                                            <span class="d-cap">View</span>
                                                                        </span>
                                                                    </span>
                                                                    <img src="<?= assets('images/misc/1.jpg') ?>" alt="" >
                                                                </a>
                                                            </figure>
                                                        </div>
                                                        ...
                                                        <div class="col-lg-6">
                                                            <blockquote class="p-5 border-color-1 rounded-20 h-100">
                                                                As a busy professional, I rely on Spinella's premium saffron to elevate my meals. The rich aroma, vibrant color, and exquisite taste never fail to transform any dish into a culinary masterpiece. It's like a little slice of luxury in every bite!
                                                            </blockquote>
                                                        </div>
                                                </div>
                                ...
                                <div id="blog-comment">
                                    ...
                                    <ol>
                                        <li>
                                            <div class="avatar">
                                                <img src="<?= assets('images/ui/avatar.png') ?>" alt="" /></div>
                                    ...
                                    <div id="comment-form-wrapper">
                                        ...
                                        <div class="comment_form_holder">
                                            <form id="contact_form" name="form1" method="post" action="#">
                                                ...
                                                <p id="btnsubmit">
                                                    <input type="submit" id="send" value="Send" class="btn-custom" /></p>
                                                </form>
                                            </div>
                                        </div>
                                    </div> 
