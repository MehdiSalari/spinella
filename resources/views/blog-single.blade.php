                ...
                <div class="col-lg-8 offset-lg-2">
                    <div class="de-post-read">
                        <div class="post-content">
                            ...
                            <div class="post-text">
                                @if ($blog->image_left || $blog->image_right)
                                        ...
                                        @if ($blog->image_left)
                                            ...
                                            @endif
                                                <figure class="hover-zoom position-relative rounded-20 overflow-hidden">
                                                    <a
                                                        href="{{ asset("assets/images/blogs/$blog->slug/$blog->image_left") }}">
                                                        <span class="d-hover">
                                                            <span class="d-text">
                                                                <span class="d-cap">View</span>
                                                            </span>
                                                        </span>
                                                        <img src="{{ asset("assets/images/blogs/$blog->slug/$blog->image_left") }}"
                                                            alt="">
                                                    </a>
                                                </figure>
                                            </div>
                                        @endif
                                            @if ($blog->image_right)
                                                ...
                                                @endif
                                                    <figure class="hover-zoom position-relative rounded-20 overflow-hidden">
                                                        <a
                                                            href="{{ asset("assets/images/blogs/$blog->slug/$blog->image_right") }}">
                                                            <span class="d-hover">
                                                                <span class="d-text">
                                                                    <span class="d-cap">View</span>
                                                                </span>
                                                            </span>
                                                            <img src="{{ asset("assets/images/blogs/$blog->slug/$blog->image_right") }}"
                                                                alt="">
                                                        </a>
                                                    </figure>
                                                </div>
                                ...
                                @endif
                                        ...
                                        @if ($blog->image_mid || $blog->mid_text)
                                            <div class="row zoom-gallery mb-4">
                                                @if ($blog->image_mid)
                                                    @if ($blog->mid_text)
                                                        <div class="col-lg-6">
                                                    ...
                                                    @endif
                                                            ...
                                                            <figure
                                                                class="hover-zoom position-relative rounded-20 overflow-hidden">
                                                                <a
                                                                    href="{{ asset("assets/images/blogs/$blog->slug/$blog->image_mid") }}">
                                                                    <span class="d-hover">
                                                                        <span class="d-text">
                                                                            <span class="d-cap">View</span>
                                                                        </span>
                                                                    </span>
                                                                    <img src="{{ asset("assets/images/blogs/$blog->slug/$blog->image_mid") }}"
                                                                        alt="">
                                                                </a>
                                                            </figure>
                                                        </div>
                                        ...
                                        <div class="post-meta">
                                            ...
                                            {{-- <span><i class="fa fa-tag id-color"></i><a href="#">News</a>, <a
                                                    href="#">Events</a></span> --}}
                                            <span><i
                                                    class="fa fa-calendar id-color"></i>{{ $blog->created_at->format('M d, Y') }}</span>
                                            <span><i
                                                    class="fa fa-comment id-color"></i>{{ $blog->comments->where('is_approved', true)->count() }}
                                                Comments</></span>
                                        </div>
                                        ...
                                        <div id="blog-comment">
                                            <h3>Comments ({{ $blog->comments->where('is_approved', true)->count() }})
                                            </h3>
                                                ...
                                                <div class="comment_form_holder">
                                                    <form id="contact_form" name="form1" method="post"
                                                        ...
                                                        <input type="email" name="email" id="email"
                                                            class="form-control" />
                                                        <div id="error_email" class="error">Please check your email
                                                        </div>

                                                        <label>Message <span class="req">*</span></label>
                                                        <textarea style="resize: none" cols="10" rows="10" name="body"
                                                            id="message" class="form-control"></textarea>
                                                        <div id="error_message" class="error">Please check your message
                                                        </div>
                                                        <div id="mail_success" class="success">Thank you. Your message
                                                            has been
                                                            sent.
                                                        </div>
