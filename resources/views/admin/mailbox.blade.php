                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover table-mailbox">
                                        <tbody>
                                            ...
                                            <tr style="cursor: pointer; height: 40px" class="clickable-row" data-href="{{ route('admin.mailbox.show', $ticket->id) }}">
                                                ...
                                                <td class="text-right mail-date" style="margin-left: 10px">{{ $ticket->created_at }}</td>
                                                <td class="text-right">
                                                    <form action="{{ route('admin.mailbox.destroy', $ticket->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
