...
@endif
    ...
    <div class="container-fluid">
        <div class="product-status mg-b-30" style="margin-top: 100px;">
            ...
            <form action="{{ route('admin.settings.update', ['product', Session::get('locale')]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PATCH')
                <div class="row">
                    <!-- Site Contents -->
                            ...
                            <h4>Product</h4>
                                ...
                                <div class="input-group mg-b-pro-edt">
                                    ...
                                    <input type="text" class="form-control" placeholder="Title"
                                        value="{{ __('product.header.title') }}" name="headerTitle"
                                ...
                                <div class="input-group mg-b-pro-edt">
                                    ...
                                    <input type="text" class="form-control" placeholder="Subtitle"
                                        value="{{ __('product.header.subtitle') }}" name="headerSub"
                                        id="edit-product-title" required>
                                </div>
                                <div class="input-group mg-b-pro-edt">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
                        ...
                        <div class="product-status-wrap">
                            ...
                            <img style="width: 100%;margin-bottom: 0px;"
                                src="<?= asset('assets/images/ss/product-header.jpeg') ?>" alt="">
                        </div>
                    </div>
