...
<div class="container-fluid">
    <div class="product-status mg-b-30" style="margin-top: 100px;">
        ...
        <form action="{{ route('admin.settings.update', ['contact', Session::get('locale')]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PATCH')
            <div class="row">
                <!-- Site Contents -->
                    ...
                    <div class="product-status-wrap">
                        ...
                        <div class="input-group mg-b-pro-edt">
                            ...
                            <input type="text" class="form-control" placeholder="Subtitle"
                                value="{{ __('contact.header.subtitle') }}" name="headerSub" id="edit-product-title"
                                required>
                        </div>
                        <div class="input-group mg-b-pro-edt">
